"""Custom asynchronous job management for geeservermap."""
...
class Async:
    ...
    def __init__(self):
        """Initialize the asynchronous job manager."""
        self._jobs = {}
        self.cleanup_running = False
        atexit.register(self._terminate)

    def _run_cleanup(self):
        """Run the cleanup thread for timed-out jobs."""
    ...
    def _terminate(self):
        """Terminate the asynchronous job manager."""
        self._jobs = None
